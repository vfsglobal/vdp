...
export const pageDefault = {
  ...
  transition: mergeTransition([
    (to, from) => {
      ...
      return {
        name:
          toPathIndex > fromPathIndex ? "page-from-right" : "page-from-left",
        mode: ""
      };
    },
    {
      //to add and remove new / old page type attribute
      beforeEnter(el) {
        $(el).attr("data-page-type", "new");
      },
      afterEnter(el) {
        $(el).removeAttr("data-page-type");
      },
      beforeLeave(el) {
        $(el).attr("data-page-type", "old");
      },
      afterLeave(el) {
        $(el).removeAttr("data-page-type");
      }
